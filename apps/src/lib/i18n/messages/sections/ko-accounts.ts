...
export const KO_ACCOUNTS_MESSAGES: MessageCatalog = {
  ...
  "未配置": "구성되지 않음",
  "刷新": "새로고침",
  "5 小时额度已重置": "5시간 한도가 재설정되었습니다",
  "5 小时额度重置券": "5시간 한도 재설정 크레딧",
  ...
  "重置额度": "한도 재설정",
  "重置额度，可用 {count} 次": "한도 재설정, {count}회 사용 가능",
  "重置额度，次数待核对": "한도 재설정, 사용 가능 횟수 확인 중",
  "重置当前 5 小时额度": "현재 5시간 한도 재설정",
  "重置券记录": "재설정 크레딧 기록",
  "重置请求未完成，请稍后重试": "재설정이 완료되지 않았습니다. 잠시 후 다시 시도하세요.",
  "此操作会消耗 1 次重置券。提交成功后无法撤销，但不会影响周额度。":
    "재설정 크레딧 1개를 사용합니다. 완료 후에는 취소할 수 없으며 주간 한도에는 영향을 주지 않습니다.",
  ...
  "可消耗一次重置券，立即恢复当前 5 小时额度":
    "재설정 크레딧 1개를 사용해 현재 5시간 한도를 즉시 복원합니다",
  "当前没有可用重置券，可查看发放记录":
